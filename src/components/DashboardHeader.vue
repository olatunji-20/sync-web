<template>
  <header class="border-b border-stone-200 bg-white">
    <div class="">
      <div
        class="flex items-center justify-between px-6.5 py-5 border-b border-[#292D321A]"
      >
        <h1
      ...
      <div
        class="flex items-center justify-between px-6.5 py-6 border-b border-[#292D321A]"
      >
