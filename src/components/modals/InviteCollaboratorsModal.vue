    ...
    <div v-show="visible" class="fixed inset-0 z-40 flex items-center justify-center p-4 bg-stone-900/50"
      ...
      <div class="w-full max-w-lg bg-white rounded-2xl shadow-xl overflow-hidden max-h-[90vh] overflow-y-auto"
        ...
        <div class="flex items-start justify-between gap-4 px-6 pt-6 pb-4">
          <div>
            <h2 id="invite-modal-title" class="text-lg font-medium text-stone-900">Invite collaborators</h2>
        ...
        <div class="px-6 py-4 border-t border-stone-100">
          <div class="flex items-center justify-between gap-4 p-4 rounded-xl bg-[#F0EDFE] border border-stone-200">
            <div class="flex items-center gap-3 min-w-0">
              <div class="w-8 h-8 rounded-full bg-[#6B4CF5] flex items-center justify-center shrink-0">
        ...
        <div class="px-6 py-1">
          <div class="w-full flex justify-between items-center gap-1">
            <div class="flex flex-1 items-center gap-2 border rounded-full p-0.5">
              <input v-model="emailInput" type="email" placeholder="Enter email..."
                class="flex-1 min-w-[160px] px-4 py-1.5 rounded-full bg-white focus:outline-none focus:ring-2 focus:ring-purple-500/30 focus:border-purple-400"
            ...
            <div class="relative" ref="roleDropdownRef">
              <div v-show="roleOpen"
                ...
                <button v-for="role in roleOptions" :key="role" type="button"
        ...
        <div class="px-6 py-3">
          <ul class="space-y-2">
            <li v-for="(collab, i) in collaborators" :key="i"
              ...
              <div class="flex items-center gap-3 min-w-0">
                ...
                <span v-if="collab.badge" class="shrink-0 px-2 py-0.5 rounded text-xs bg-emerald-50 text-emerald-600">
                  {{ collab.badge }}
                </span>
              </div>
              <div class="relative shrink-0" :data-collab-index="i">
                ...
                <div v-show="openCollabDropdown === i"
                  ...
                  <button type="button" class="w-full px-4 py-2 text-left text-sm text-red-600 hover:bg-red-50"
        ...
        <div class="p-4 border-t border-stone-100 bg-stone-50">
          <div class="flex items-center justify-between">
            <div>
              <p class="font-medium text-stone-900 text-md">Add extra security to your link</p>
              <p class="text-xs text-stone-500">Set a password to control who can join via your link</p>
            </div>
            <button type="button"
