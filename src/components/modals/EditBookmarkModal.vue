    ...
    <div v-show="visible" class="fixed inset-0 z-40 flex items-center justify-center p-4 bg-stone-900/50"
      ...
      <div class="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden" role="dialog" aria-modal="true"
        ...
        <div class="flex items-start justify-between gap-4 px-6 pt-6 pb-4">
          <div>
            <h2 id="edit-bookmark-title" class="text-lg font-medium text-stone-900">Edit bookmark</h2>
        ...
        <form class="py-5 space-y-4" @submit.prevent="onSubmit">
          <div class="px-6">
            ...
            <div class="relative">
              <input id="edit-collection" v-model="form.collection" type="text" placeholder="Enter text"
              ...
              <svg class="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-stone-400 pointer-events-none"
          ...
          <div class="px-6">
            ...
            <input id="edit-tags" v-model="form.tags" type="text" placeholder="Enter text"
              class="w-full px-4 py-2 rounded-full border border-stone-200 bg-stone-50 focus:outline-none focus:ring-2 focus:ring-purple-500/30 focus:border-purple-400" />
          </div>
          <div class="px-6">
            <label for="edit-url" class="block text-sm font-medium text-stone-700 mb-1.5">URL</label>
            <input id="edit-url" v-model="form.url" type="text" placeholder="Enter text"
              class="w-full px-4 py-2 rounded-full border border-stone-200 bg-stone-50 focus:outline-none focus:ring-2 focus:ring-purple-500/30 focus:border-purple-400" />
          </div>
