    ...
    >
      ...
      >
        ...
        <div class="flex items-start justify-between gap-4 px-6 pt-6 pb-4">
          <div>
            <h2 id="add-password-title" class="text-lg font-bold text-stone-900">Add a password for security</h2>
        ...
        <form class="px-6 pb-6 space-y-4" @submit.prevent="onSubmit">
          <div>
            <label for="add-password-enter" class="block text-sm font-medium text-stone-700 mb-1.5">Enter password</label>
            <div class="relative">
              <input
                id="add-password-enter"
                v-model="password"
                :type="showPassword ? 'text' : 'password'"
                placeholder="Enter text"
                class="w-full px-4 py-2.5 pr-11 rounded-xl border border-stone-200 bg-stone-50 focus:outline-none focus:ring-2 focus:ring-[#6B4CF5]/30 focus:border-[#6B4CF5]"
              />
              <button
                type="button"
          ...
          <div>
            <label for="add-password-reenter" class="block text-sm font-medium text-stone-700 mb-1.5">Re-enter password</label>
            <div class="relative">
              <input
                id="add-password-reenter"
          ...
          <div class="flex justify-end pt-2">
            <button
              type="submit"
              class="px-5 py-2.5 rounded-xl bg-[#5B21B6] text-white font-medium hover:bg-[#4C1D95] transition-colors"
            >
              Save Password
            </button>
          </div>
